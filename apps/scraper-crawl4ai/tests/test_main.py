...
from scraper_crawl4ai.main import run
...
async def test_run_uses_markdown_mode(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("scraper_crawl4ai.main.crawl_markdown", fake_crawl_markdown)
...
async def test_run_uses_llm_mode(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("scraper_crawl4ai.main.extract_with_llm", fake_extract_with_llm)
